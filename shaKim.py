...
#GITHUB  : 
#--------------------------------------------------------------------------#
ddddddd="""DECOMPILED BY MICHAEL COVENANT"""
...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/23.0.0.87.19;FBBV/20454115;FBDM/{density=2.1,width=768,height=1024};FBLC/el_CY;FBCR/Mint Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-T355Y;FBSV/5.0;nullFBCA/armeabi-v7a:armeabi;]"
...
def pp():
	...
	try:
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+9233303257337?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*SHAIKH*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
